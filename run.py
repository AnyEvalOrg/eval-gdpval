#!/usr/bin/env python3
"""Run ONE problem of gdpval through TrustedRouter and emit a reproducibility bundle.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one gdpval problem via TrustedRouter")
