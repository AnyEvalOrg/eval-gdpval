...
GDPval measures model performance on economically valuable, real-world tasks across 44
occupations.
...
| | |
|---|---|
| Upstream | [`src/inspect_evals/gdpval`](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/src/inspect_evals/gdpval) |
| Group | Assistants |
| Total samples | 220 |
...
- `huggingface` — `openai/gdpval` (pinned)
- `huggingface` — `openai/gdpval` (pinned)
